...
const VIBRANT_COLORS = ['#22c55e', '#3b82f6', '#eab308', '#a855f7', '#06b6d4', '#f43f5e'];
...
export const RevenueBreakdownPie = ({ data, title = "Composição de Receitas" }: RevenueBreakdownPieProps) => {
